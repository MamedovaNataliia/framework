...
class Instagram {
    ...
    protected $_endpointUrls = array(
        ...
        //'https://api.instagram.com/v1/users/%s/media/recent/?access_token=%s&max_id=%s&min_id=%s&max_timestamp=%s&min_timestamp=%s&count=%s',
    ...
    */
    ...
    protected function _setOauthToken() {
        ...
        $this->_httpClient->setPostParam('code', $this->_config['code']);//$this->getAccessCode());
